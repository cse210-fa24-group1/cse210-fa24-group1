...
Lastly, below everything, there is an "Export" button. This button will export the currently displayed data to the user via email. If the user had clicked on "December 2024" through the monthly calender and then clicked the "Export" button, they will download a CV file containing data of their expense history from the month December 2024. If no time period was selected, they will get the whole history data.
